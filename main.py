...
# Студенты
student_1 = Student('Сара', 'Конор', 'Жен')
student_1.courses_in_progress += ['Python', 'Git']
student_1.finished_courses += ["Введение в програмирование"]

student_2 = Student('Джон', 'Конор', 'Муж')
student_2.courses_in_progress += ['Python', 'Git']
student_2.finished_courses += ["Введение в програмирование"]

# Лекторы
lecturer_1 = Lecturer('Вася', 'Облепихин')
lecturer_1.courses_attached += ['Python']

lecturer_2 = Lecturer('Андрей', 'Брусникин')
lecturer_2.courses_attached += ['Python']

# Проверяющие
reviewer_1 = Reviewer('Павел', 'Джофри')
reviewer_1.courses_attached += ['Python']

reviewer_2 = Reviewer('Василий', 'Жопоруков')
